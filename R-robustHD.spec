...
Version  : 0.8.1
Release  : 23
URL      : https://cran.r-project.org/src/contrib/robustHD_0.8.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/robustHD_0.8.1.tar.gz
...
%setup -q -n robustHD
pushd ..
cp -a robustHD buildavx2
popd
pushd ..
cp -a robustHD buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719948158
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/robustHD/libs/robustHD.so
/V4/usr/lib64/R/library/robustHD/libs/robustHD.so
